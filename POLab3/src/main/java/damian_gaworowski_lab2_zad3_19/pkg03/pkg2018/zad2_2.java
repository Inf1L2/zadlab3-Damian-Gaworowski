...
public class zad2_2 {
     public static void main(String[] args){
         ...
         String sl1 = new String("Przykład to jeden");
         String sl2 = new String("Przykład dwa to dwa");
         String sl3 = new String("przykład to trzy");
         String sl4 = new String("Przykład     to     cztery");
         ...
         String[] sl1Dzielenie = sl1.split("to");// dzieli na czesci: pierwsza przed arg druga po 
         String part1 = sl1Dzielenie[0];
         String part2 = sl1Dzielenie[1];
